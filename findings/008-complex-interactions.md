...
**Bug 009:** `compare_versions` crashes when documents have links embedded. See `bugs/009-compare-versions-crashes-with-links.md`.
...
- **Finding 002:** Transclusion content identity - foundation for this behavior
- **Finding 007:** Version semantics - versioning also preserves content identity
- **Finding 004:** Link endpoint semantics - how links are stored and searched
