# Finding 0011: Convention Over Enforcement - Udanax Green Design Philosophy
...
| Cost | Example |
|------|---------|
| **Subtle bugs** | Bug 0009 - crash when conventions violated |
...
- **Finding 0009**: Document address space structure (the primary convention)
- **Finding 0010**: Unified storage abstraction leaks (where conventions break)
- **Bug 0009**: compare_versions crash (convention violation consequence)
- **Bug 0010**: acceptablevsa always TRUE (missing enforcement)
