# Finding 0040: Link Removal from POOM via DELETEVSPAN
...
This mirrors the orphaned link behavior (Finding 0024) but in reverse:
...
- **Finding 0024**: Link permanence and orphaned links (links survive endpoint deletion)
- **Finding 0029**: Link search endpoint removal (links undiscoverable when endpoints deleted)
- **Finding 0038**: POOM subspace independence (2.x link subspace separate from 1.x text)
