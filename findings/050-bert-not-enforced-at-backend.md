# Finding 050: BERT Tokens Are Not Enforced by the Back End
...
- **Finding 014**: BERT access control mechanism (documents the BERT design)
- **Finding 011**: Convention over enforcement (this is the most extreme case)
