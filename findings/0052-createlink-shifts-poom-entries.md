# Finding 0052: CREATELINK Shifts POOM Entries

**Date:** 2026-02-07
**Category:** Link Operations / POOM Structure
**Agent:** Gregory
**Related:** EWD-035 (The Content Discipline), Finding 0027 (Insertion Order Semantics)
...
- **Finding 0027** (Insertion Order Semantics): INSERT shifts existing entries right
- **Finding 0041** (Enfilade Insertion Order Dependency): Physical tree structure depends on insertion order
...
4. **Does DELETEVSPAN on 2.x positions shift remaining links?** (See Finding 0040 - Link Removal from POOM)
