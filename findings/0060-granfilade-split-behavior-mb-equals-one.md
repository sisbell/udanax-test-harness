# Finding 0060: Granfilade Split Behavior with M_b = 1
...
**Related:** Finding 0058 (levelpull disabled), EWD-006 (Enfilade Structure)
...
From Finding 0058, we know that **`levelpull` is disabled** (returns 0 immediately).
...
- **Finding 0058:** levelpull disabled — prevents tree collapse
