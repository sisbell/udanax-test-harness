# Finding 0028b: Link Discovery via Content Identity

**Date:** 2026-01-31
**Related:** Finding 0004, Finding 0010, Finding 0027b
...
- **Finding 0010**: Unified storage abstraction (links stored via I-addresses)
- **Finding 0027b**: retrieve_contents requires source document open
