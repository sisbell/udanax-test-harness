...
**Related Bug**: [Bug 015 - homedocids filter has no effect](../bugs/015-homedocids-filter-ignored.md)
...
- [Bug 015](../bugs/015-homedocids-filter-ignored.md) - The filter doesn't work
- Finding 024 - Link permanence and orphaned links
