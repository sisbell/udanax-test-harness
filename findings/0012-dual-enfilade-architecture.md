...
- **Finding 0009:** Document address space (how content is stored in granf)
- **Finding 0004:** Link endpoint semantics (how links are indexed in spanf)
- **Finding 0011:** Convention over enforcement (no transactional guarantees documented)
