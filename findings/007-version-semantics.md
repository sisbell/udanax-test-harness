...
- **Finding 002: Transclusion Content Identity** - Versioning and transclusion both preserve content identity; the same principles apply
- **Finding 004: Link Endpoint Semantics** - Links are bound to content identity, which is why they transfer to versions
- **Finding 005: Link Survivability** - Links survive document edits through content identity preservation
