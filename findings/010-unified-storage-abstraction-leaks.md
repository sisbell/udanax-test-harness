# Finding 010: Unified Storage Abstraction Leaks

**Date:** 2026-01-30
**Related:** Finding 009 (Document Address Space Structure), Bug 009
...
### 1. Version Comparison (`compare_versions` / Bug 009)
...
**Evidence:** Bug 009 - SIGABRT when link subspace spans are processed
...
- **Finding 009:** Document address space structure (defines the subspaces)
- **Finding 011:** Convention over enforcement design philosophy (why validation is missing)
- **Bug 009:** Crash demonstrating compare_versions leak
- **Bug 010:** acceptablevsa always returns TRUE (no V-position validation)
- **Finding 004:** Link endpoint semantics (links attach to content identity)
