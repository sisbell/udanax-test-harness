# Finding 028: Edge Case Semantics
...
| Create link | Zero-width endpoints | **CRASH** (Bug 017) |
...
But zero-width endpoints crash (Bug 017).
...
- Finding 002: Transclusion content identity is immutable
- Finding 016: Rearrange operations
- Finding 027: Insertion order semantics
