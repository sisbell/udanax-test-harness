# Finding 0048: FOLLOWLINK Returns I-Addresses, Filtering Unreferenced Addresses During V-Conversion
...
**Related:** Finding 0035 (Query Operations), EWD-030 (Deletion Problem, DEL5), EWD-032 (FEBE Contract, FE5)
...
| RETRIEVEENDSETS | Content V-spec | Spanfilade → I-addresses → POOM → V-addresses | Same filtering (Finding 0035) |
...
- **Finding 0035**: RETRIEVEENDSETS also filters unreferenced addresses during I-to-V conversion
