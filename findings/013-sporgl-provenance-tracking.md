# Finding 013: The Sporgl - Content Provenance Tracking
...
- **Finding 009:** Document address space (V-addresses)
- **Finding 012:** Dual enfilade architecture (spanf uses sporgls)
- **Finding 002:** Transclusion content identity (sporgl tracks this)
