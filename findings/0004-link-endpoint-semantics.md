# Finding 0004: Link endpoints track content identity

**Date discovered:** 2026-01-30
**Updated:** 2026-01-30 (after Bug 0008 client fixes)
...
**CORRECTED:** After fixing client-side bugs (Bug 0008), all link survivability tests now pass. Links DO track content identity and survive document modifications, consistent with transclusion semantics.
...
- Bug 0008: ~~Backend crashes on linked document edit~~ RESOLVED (client bugs)
- Bug 0009: compare_versions crashes when documents have links (link subspace issue)
- Finding 0002: Transclusion preserves immutable content identity
- Finding 0003: Multi-span operations preserve independent identity
- Finding 0009: Document address space structure (explains how links are stored at V-position 0.x)
