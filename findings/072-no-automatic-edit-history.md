# Finding 072: No Automatic Edit History or Backtrack Capability
...
**Related:** Finding 064 (DELETE irreversible in I-space), Finding 043 (CREATENEWVERSION semantics)
...
From Finding 064, `do1.c:27-43` (`doinsert`):
...
From Finding 043, `do1.c:264-303`:
...
- **Finding 064:** DELETE Is Irreversible in I-Space - Explains why DELETE + re-INSERT breaks identity
- **Finding 043:** CREATENEWVERSION Copies Text Only - Details version creation semantics
- **Finding 007:** Version Semantics - How versions preserve content identity
- **Finding 030:** INSERT Allocates Fresh I-Addresses - Why re-typing doesn't restore identity
- **Finding 057:** Spanfilade Write-Only - Even the reverse index isn't cleaned up on DELETE
