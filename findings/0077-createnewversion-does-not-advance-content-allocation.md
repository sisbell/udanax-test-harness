# Finding 0077: CREATENEWVERSION Does Not Advance Content Allocation (Σ.next)
...
From Finding 0063, we know that CREATELINK **does** advance the content allocation counter:
...
Like DELETE (Finding 0061), CREATENEWVERSION does **not** affect the content allocation counter. It only:
...
- **Finding 0061: I-Address Allocation is Monotonic** — Documents stateless query-and-increment for content
- **Finding 0063: CREATELINK Breaks I-Address Contiguity** — Contrast: CREATELINK **does** advance content allocation
- **Finding 0068: VERSION Allocates Addresses as Children** — Documents document address allocation (this finding documents content allocation)
- **Finding 0021: Address Allocation and Account Boundaries** — Documents `findisatoinsertnonmolecule` mechanism
