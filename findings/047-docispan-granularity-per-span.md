# Finding 047: DOCISPAN Granularity is Per-Span, Not Per-Byte
...
### I-Span Consolidation (Finding 033)

From Finding 033: I-Space Consolidates Adjacent Addresses:
...
- But Finding 033 says sequential inserts consolidate, so actually ~1000 entries
...
- **Finding 033**: I-Space Consolidates Adjacent Addresses (explains I-span consolidation)
- **Finding 036**: INSERT Creates DOCISPAN Entries (documents INSERT → DOCISPAN path)
- **Finding 012**: Dual Enfilade Architecture (granf + spanf separation)
