...
This is consistent with Finding 032 which documented CREATENEWVERSION behavior, but this test PROVES the text-only copying at the POOM level.
...
- **Finding 032**: CREATENEWVERSION behavior (now proven at POOM level)
- **Finding 038**: POOM subspace independence (links at 2.x separate from text at 1.x)
- **Finding 040**: Link removal from POOM (links not in document POOM but in spanf)
