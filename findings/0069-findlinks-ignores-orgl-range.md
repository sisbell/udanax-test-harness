# Finding 0069: find_links Ignores Orgl Range Parameter
...
- **Finding 0012**: Dual enfilade architecture (spanfilade indexes links by span × orgl)
- **Finding 0026**: Link discovery through content identity (links found via shared I-addresses, not document scope)
