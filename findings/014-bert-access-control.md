# Finding 014: BERT - Document Access Control Mechanism
...
- **Finding 011**: Convention over enforcement (BERT is one of the few enforced rules)
- **Bug 008**: Had issues with opening documents multiple times
