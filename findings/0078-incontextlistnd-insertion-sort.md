# Finding 0078: incontextlistnd Performs Insertion-Sort by V-Address
...
- Insertion order (see Finding 0041)
- Split/rebalance operations (see Finding 0071)
...
- Diagonal ordering in 2D enfilades (Finding 0071)
...
- **Finding 0039**: Internal transclusion I→V mapping - confirms that `incontextlistnd` accumulates all contexts
- **Finding 0041**: Enfilade insertion order dependency - explains why tree structure is not V-sorted
- **Finding 0071**: 2D recombine diagonal ordering - explains non-V-ordering in tree structure
- **Finding 0027**: Insertion order semantics - discusses retrieval ordering for different operations
