# Finding 039: Internal Transclusion and I→V Mapping
...
- **Finding 002**: Transclusion content identity - establishes that vcopy preserves I-addresses
- **Finding 008**: Complex interactions - links follow content through transclusion (between documents)
- **Finding 009**: Document address space structure - POOM as unified V→I storage
- **Finding 013**: Sporgl provenance tracking - how I-addresses are propagated during vcopy
- **Finding 033**: I-space consolidates adjacent addresses - affects the granularity of I-address regions
- **Finding 037**: Link endsets split on discontiguous I-addresses - related V→I conversion behavior
