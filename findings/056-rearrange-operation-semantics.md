# Finding 056: Rearrange Operation Semantics
...
[Finding 016, test: `pivot_adjacent_regions`]
...
[Finding 016, test: `swap_non_adjacent`]
...
**Behavioral evidence:**
- Links bound to rearranged content remain discoverable [Finding 016, test: `swap_with_links`]
...
This violates the content discipline (CD0) which requires content type to match subspace. See [Finding 051].
...
- **Finding 016**: Rearrange operations (pivot and swap) - behavioral tests
- **Finding 051**: Rearrange can cross subspace boundaries
- **Finding 002**: Content identity immutability (transclusion)
...
- `udanax-test-harness/findings/016-rearrange-operations.md` - Behavioral findings
