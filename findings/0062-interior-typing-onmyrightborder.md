# Finding 0062: Interior Typing and the ONMYRIGHTBORDER Case
...
- **Finding 0033**: I-space consolidates adjacent addresses (confirms MAT-2)
- **Finding 0046**: POOM handles duplicate I-addresses by extension
- **Finding 0061**: I-address allocation is monotonic (confirms MAT-1)
