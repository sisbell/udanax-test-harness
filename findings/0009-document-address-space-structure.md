# Finding 0009: Document Address Space Structure and Link Storage

**Date:** 2026-01-30
**Related:** Bug 0009 investigation
...
3. **Bugs arise from uniformity assumptions** - Like Bug 0009

### The Right Fix for Bug 0009
...
- **Finding 0002**: Transclusion preserves immutable content identity (I-addresses)
- **Finding 0004**: Links track content identity (uses same I-address mechanism)
- **Finding 0007**: Versions preserve content identity (same transitive through I-addresses)
- **Finding 0010**: Unified storage abstraction leaks (comprehensive list of where this breaks)
- **Finding 0011**: Convention over enforcement design philosophy (why the system works this way)

## Related Bugs

- **Bug 0009**: compare_versions crashes with links - root cause is that link subspace introduces I-addresses (link ISAs) that don't participate in text content comparison
