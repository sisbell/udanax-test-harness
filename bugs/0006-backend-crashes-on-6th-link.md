# Bug 0006: Backend crashes when creating 6th link in a document

**Date discovered:** 2026-01-30
**Status:** Fixed (resolved by Bug 0005 fix - malformed link type addresses were the cause)
...
1. Fix pyxi's link type addresses (Bug 0005) - use proper element addresses
...
- `febe/client.py` - LINK_DOCID and type constants (Bug 0005)
...
Bug 0005's address format fix reduced the number of spanfilade children per link,
