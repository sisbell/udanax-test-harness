# Bug 0009: Backend crashes on compare_versions when documents have links
...
- Bug 0008: Backend crashes on linked document edit (different crash scenario) - FIXED
- Finding 0007: Version semantics (compare_versions works fine without links)
...
of Bug 0020: a stack buffer overflow in `recombinend()` caused by an off-by-one
