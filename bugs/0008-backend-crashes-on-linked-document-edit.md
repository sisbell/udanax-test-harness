# Bug 0008: Backend crashes when editing documents with links
...
Bug 0006 (crashes on 6th link) is likely the same root cause - the POOM enfilade tree structure becomes corrupted or inconsistent when too many links are present or when modifications occur.
...
- Bug 0006: Backend crashes on 6th link (same root cause)
- Bug 0007: Backend crashes on delete-all (similar crash pattern, now fixed)
