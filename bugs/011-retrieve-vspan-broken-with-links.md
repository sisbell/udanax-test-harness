# Bug 011: retrieve_vspan returns invalid span for documents with links
...
- **Finding 009**: Document address space structure
- **Finding 017**: vspan vs vspanset differences
- **Bug 010**: No V-position validation (related subspace issue)
