# Bug 0016: Link Count Limit - Regression/Not Fully Fixed

**Date discovered:** 2026-01-31
**Status:** Open
**Severity:** High - backend crash (abort trap)
**Related:** Bug 0006 (previously marked as fixed)
...
## Why Bug 0006 Was Marked Fixed

Bug 0006 focused on malformed link type addresses (Bug 0005). After fixing the type address format, some scenarios that previously crashed started working. However, the underlying link count limit issue was not resolved - it was masked by the address fix changing the crash threshold.
